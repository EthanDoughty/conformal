...
% EXPECT: r1_symbolic = matrix[n x n]
% EXPECT: r2_concrete = matrix[2 x 3]
% EXPECT: r2_symbolic = matrix[k x m]
% EXPECT: e0 = scalar
% EXPECT: e1_concrete = matrix[2 x 3]
% EXPECT: e1_symbolic = matrix[n x m]
% EXPECT: t0 = scalar
% EXPECT: t1_concrete = matrix[3 x 2]
% EXPECT: t1_symbolic = matrix[m x n]
% EXPECT: q0 = scalar
...
% EXPECT: eye_symbolic = matrix[n x n]
% EXPECT: eye_symbolic_2arg = matrix[m x n]
...
% EXPECT: randn_2_symbolic = matrix[k x 2]
% EXPECT: abs_scalar = scalar
% EXPECT: abs_concrete = matrix[2 x 3]
% EXPECT: abs_symbolic = matrix[n x m]
...
% EXPECT: transpose_symbolic = matrix[m x n]
