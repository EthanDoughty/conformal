...
let KNOWN_BUILTINS : Set<string> =
    Set.ofList [
        ...
        "datenum"; "datestr"; "datetick"; "dbstack"; "deal"; "deblank"; "dec2hex"; "deconv"; "deg2rad"; "delete"
        "det"; "diag"; "diff"; "dir"; "disp"; "display"; "double"
        "eig"; "eigs"; "error"; "eval"; "evalc"; "evalin"; "exist"; "exp"; "expm"; "eye"
        "assignin"
        "fitgmdist"; "fmincon"; "fminunc"; "fminsearch"; "fsolve"
        "false"; "fclose"; "feval"; "fft"; "fft2"; "fftshift"; "fieldnames"; "fileparts"
        "find"; "fix"; "flipud"; "fliplr"; "floor"; "fopen"; "fprintf"; "fread"; "fscanf"
        "fgetl"
        ...
        "secd"; "sign"; "sin"; "sind"; "single"; "sinh"; "size"; "sort"; "sparse"; "spdiags"; "spline"; "sprank"
        "shaperead"
        "sprintf"; "sqrt"; "sqrtm"; "std"; "str2double"; "str2func"; "str2num"; "strcmp"; "strcmpi"; "strfind"
        "strcat"; "strjoin"; "strmatch"; "strrep"; "strsplit"; "strtrim"; "string"; "struct"
        ...
        "var"; "vertcat"
        "warning"; "which"; "whos"; "wishrnd"; "wrapTo180"; "wrapTo360"; "wrapToPi"
        "xor"
        "zeros"
...
let SUPPRESSED_CMD_STMTS : Set<string> =
    Set.ofList [
        ...
        "datetick"; "drawnow"; "pause"; "set"; "get"; "xlim"; "ylim"; "zlim"
